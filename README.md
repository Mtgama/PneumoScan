...
PneumoScan یک سامانه وب مبتنی بر یادگیری عمیق برای تشخیص خودکار ذات‌الریه از تصاویر رادیوگرافی قفسه سینه است. این سامانه با بهره‌گیری از مدل DenseNet121، به دقت 95.2٪ دست یافته و با هدف کمک به غربالگری سریع‌تر، دقیق‌تر و هوشمندانه‌تر تصاویر پزشکی طراحی شده است.
...
پس از دانلود و اکسترکت کردن، فایل `bestmodelfinalhamine.keras` را در پوشه اصلی پروژه قرار دهید:
